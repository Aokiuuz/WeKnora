...
// Package docs exposes the generated Swagger specification.
package docs
        ...
        "/evaluation/tasks/{task_id}/questions/{sample_index}/ratings": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "rubric_key、rubric_version、rubric_snapshot、score 和 comment",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "internal_handler.EvaluationRequest": {
            ...
            "properties": {
                ...
                "configuration": {
                    "description": "Configuration optionally overrides resolved retrieval/rerank/generation parameters; every override enters the experiment snapshot.",
