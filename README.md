...
<p align="center">
    ...
    <a href="./CHANGELOG.md">
        <img alt="Version" src="https://img.shields.io/badge/version-0.7.3-2e6cc4?labelColor=d4eaf7">
    </a>
</p>
...
- **v0.7.3** — Hardened cross-workspace authorization and signed storage paths; added reproducible MAP/NDCG v2 evaluation with result-integrity verification; made model-stream accounting terminal-atomic; isolated concurrent evaluation UI requests; aligned readiness probes, Helm images, release artifacts and dependency locks.
