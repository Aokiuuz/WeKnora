...
- **v0.7.3** — Hardened cross-workspace authorization and signed storage paths; added reproducible MAP/NDCG v2 evaluation with write-time result invariants; made model-stream accounting terminal-atomic; isolated concurrent evaluation UI requests; aligned readiness probes, Helm images, release artifacts and dependency locks.
