...
python scripts/prepare-public-evaluation.py --dataset {slug} --cache-dir D:/XINIUNIAO/.cache/public-datasets
python scripts/prepare-public-evaluation.py --dataset {slug} --cache-dir D:/XINIUNIAO/.cache/public-datasets --download
python scripts/prepare-public-evaluation.py --check --verify-source --dataset {slug} --cache-dir D:/XINIUNIAO/.cache/public-datasets
```
